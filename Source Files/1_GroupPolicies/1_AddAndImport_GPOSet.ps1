...
.DESCRIPTION
    ...
    - Reads and validates the XML manifest (`manifest.xml`) within the backup folder (`EF_GPOSet_latest`)
...
.Example
	PS> powershell.exe -ExecutionPolicy Bypass -File "C:\Scripts\AddAndImport_EF-GPOSet.ps1"
